...
public class FulfillmentController {
    ...
    @ApiOperation("O2O 下单（Redis预扣 + 写DB + MQ落库）")
    ...
    @ApiOperation("支付回调（状态: PENDING → PAID）")
    ...
    @ApiOperation("出库确认（FIFO批次分配，状态: PAID → OUTBOUND）")
